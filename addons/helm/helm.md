...
```bash
$ MYSQL_ROOT_PASSWORD=$(kubectl get secret --namespace default mydb-mysql -o jsonpath="{.data.mysql-root-password}" | bash64 --decode; echo)
```
```bash
...
NAME       	NAMESPACE	REVISION	UPDATED                             	STATUS  	CHART      	APP VERSION
mydb-custom	default  	3       	2020-03-09 19:58:38.810652 +0900 KST	deployed	mysql-1.6.2	5.7.28
```
