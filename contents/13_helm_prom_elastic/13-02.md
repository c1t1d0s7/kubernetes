...
#### (3) kube-prometheus
Prometheus 설치 차트로, prometheus-operator와 YAML 리소스 파일의 모음을 결합한 Prometheus 배포 방법이다. 예전에는 Helm 차트로 제공되었지만, 더이상 Helm 차트가 아니다.
...
![Grafana 대시보드](img/15_prometheus_grafana.png)
